...
/* --- YOUR COMPONENT CODE GOES HERE --- */
 const values = [
    ...
    },
    {
        icon: "🚚",
        title: "Roast-to-Order Shipping",
        description: "We don't pre-roast and shelve. Your beans are roasted after you order and shipped within 1-2 days. Free delivery on orders over $50."
    }
 ];
    ...
    return (
        <div className="about-content">
            ...
            <div className="about-story-grid">
                <ScrollReveal animation="fade-left" className="about-story-text">
                ...
                <ScrollReveal animation="fade-right" delay={0.2} className="about-story-images">
                    <div className="about-image-stack">
                        <img 
                            src={coffeePlants} 
                            alt="Coffee plants" 
