    ...
    return (
        <>
            ...
            <div className="hero-text-column" id="home">
                ...
                >
                    Farm-to-cup single-origin beans from Ethiopia, Colombia & Beyond. Freshly roasted in small batches and shipped directly to your door within 48 hours.
                </motion.p>
                ...
                >
                    <span className="star-rating">★★★★★ 5 from 2,400 customers</span>
                    <span className="hero-trust-divider" />
                    <span className="free-shipping">Free shipping on orders over $50</span>
                </motion.div>
            </div>
            ...
            <div className="hero-art-container">
                <motion.img
                    ...
                    initial={{ scale: 1.35, opacity: 0, y: 0, x: 60}}
                    animate={{ scale: 1.35, opacity: 1, y: 0, x: 0}}
